...
#
# NOTE: this is a duplicate of tower_cli/exceptions.py for backward compatibility
# with Ansible Tower modules.

from src.main.resources import click
from src.main.resources.click import get_text_stderr
